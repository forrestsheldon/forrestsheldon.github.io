---
title: "Exploring the Data I - Cell Lines"
...
Humans generally do not like parting with their cells. At the same time, researchers need a constantly renewing source
of cells that behave consistently. Continuous cell lines are designed to meet this need. They keep dividing in a dish,
providing a renewable and reasonably consistent experimental system.
...
I had also intended to include an artifical knockdown baseline, were we just knockdown the target gene expression, but it turns out
that the evaluation metrics always neglect the target gene. We will have to wait for the linear response baseline for something
more interesting than the controls.
